...
Common guidelines for contributing to Pulsar projects
...
[additional guidelines](#additional-guidelines-for-pulsar-team).
...
## Table of contents
  ...
  * [Additional guidelines for Pulsar Team](#additional-guidelines-for-pulsar-team)
...
## Additional guidelines for Pulsar Team
...
1. Go to the top level URL of the
  [NewsCorp Organization](https://github.com/newscorp-ghfb)

2. Click on [**New**] then:
   * Make sure the **Owner** is set to pulsar
